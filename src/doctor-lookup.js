export class DoctorRequest {
  getDoctorInfo(docName,condition) {
    return new Promise(function (resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?name=${docName}&${specialty}&location=45.520645,-122.677452,100&skip=2&limit=10&user_key=f1ca4d79ccf5825a4f879f0f53844461`;
